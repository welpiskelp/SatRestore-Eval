"""Kaggle kernel: clone the repo, stage the dataset, run the real fold-1 training run
(configs/run_full_fold1.json, locked from the pilot: medium model, 100 epochs, ~2h on one T4),
...
CONFIG = "configs/run_full_fold1.json"
...
def main():
    ...
    print("full fold-1 run finished; runs/ and db/results_pilot_full.sqlite are under /kaggle/working/SatRestore-Eval", flush=True)
