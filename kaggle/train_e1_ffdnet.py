"""Kaggle kernel: E1 baseline -- FFDNet-style model (conditioned, non-blind, different architecture
family), widened to match the main model's parameter count so the comparison isn't confounded by
model size. Trained and evaluated the same way as configs/run_full_fold0.json.
...
CONFIG = "configs/e1_ffdnet_fold0.json"
