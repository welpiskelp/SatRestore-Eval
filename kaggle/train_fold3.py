"""Kaggle kernel: clone the repo, stage the dataset, run the real fold-3 training run
(configs/run_full_fold3.json, locked from the pilot: medium model, 100 epochs, ~2h on one T4),
...
CONFIG = "configs/run_full_fold3.json"
...
def main():
    ...
    print("full fold-3 run finished; runs/ and db/results_pilot_full.sqlite are under /kaggle/working/SatRestore-Eval", flush=True)
